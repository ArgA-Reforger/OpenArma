...
def sql_type_to_sqlalchemy(typing: str) -> str:
    """
    Convert an SQL type to an SQLAlchemy type
...
def sql_type_to_pydantic(typing: str) -> str:
    """
    Convert an SQL type to a Pydantic type
...
def sql_type_to_sqlalchemy_name(typing: str) -> str:
    """
    Convert an SQL type to a valid SQLAlchemy type name (used for code generation)
