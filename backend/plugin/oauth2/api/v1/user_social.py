...
@router.get('/me/bindings', summary='Get the social accounts already bound to the user', dependencies=[DependsJwtAuth])
...
@router.get('/me/binding', summary='Get the binding authorization URL', dependencies=[DependsJwtAuth])
...
@router.delete('/me/unbinding', summary='Unbind a user social account', dependencies=[DependsJwtAuth])
