...
@router.get('', summary='Get the Github authorization URL')
...
@router.get(
    ...
    description='After Github authorization, automatically redirect back to this address, fetch the user info, '
