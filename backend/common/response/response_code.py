...
class CustomResponse:
    """
    Provides open-ended response status codes instead of an enum, useful if you want to customize the response message
    """
...
class StandardResponseCode:
    ...
    HTTP_302 = 302  # FOUND: Found (temporarily moved)
