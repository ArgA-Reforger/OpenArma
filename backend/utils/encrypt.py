...
class AESCipher:
    ...
    def __init__(self, key: bytes | str) -> None:
        ...
        :param key: key, 16/24/32 bytes or a hex string
        :return:
        """
    ...
    def decrypt(self, ciphertext: bytes | str) -> str:
        ...
        :param ciphertext: ciphertext before decryption, bytes or a hex string
        :return:
        """
...
class ItsDCipher:
    ...
    def __init__(self, key: bytes | str) -> None:
        """
        Initialize the ItsDangerous cipher
