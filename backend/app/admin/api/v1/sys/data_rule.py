...
@router.get('/models', summary='Get models available for data rules', dependencies=[DependsJwtAuth])
async def get_data_rule_models() -> ResponseSchemaModel[list[str]]:
    models = await data_rule_service.get_models()
    return response_base.success(data=models)


@router.get('/models/{model}/columns', summary='Get the columns of a model available for data rules', dependencies=[DependsJwtAuth])
...
@router.get('/value-template-variables', summary='Get template variables available for data rule values', dependencies=[DependsJwtAuth])
...
@router.get('/{pk}', summary='Get data rule detail', dependencies=[DependsJwtAuth])
...
@router.get(
    '',
    summary='Get all data rules, paginated',
    dependencies=[
        DependsJwtAuth,
        DependsPagination,
    ],
