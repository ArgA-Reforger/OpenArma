...
@router.get('/sidebar', summary='Get the user menu sidebar', description='Adapted for vben admin v5', dependencies=[DependsJwtAuth])
...
@router.get('/{pk}', summary='Get menu detail', dependencies=[DependsJwtAuth])
async def get_menu(
