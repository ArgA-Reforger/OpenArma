...
@router.get('/{pk}', summary='Get data scope detail', dependencies=[DependsJwtAuth])
...
@router.get('/{pk}/rules', summary='Get all rules of a data scope', dependencies=[DependsJwtAuth])
...
@router.get(
    '',
    summary='Get all data scopes, paginated',
    dependencies=[
        DependsJwtAuth,
        DependsPagination,
    ],
...
@router.delete(
    '',
    summary='Batch delete data scopes',
    dependencies=[
