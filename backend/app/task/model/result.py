...
"""
Overrides all internal models of celery.backends.database.models, adapted so fba can
create tables and alembic migrations work
"""
...
class TaskSet(MappedBase):
    ...
    __table_args__ = {'comment': 'Task set result table'}
